...
This is the web application for knuvu, a discussion platform.

## Configuring Your Local Environment

In order to contribute to development of the knuvu web app, you'll need to
...
Once you clone this repository, change to it, i.e `cd code/knuvu/web/` and
run:

    vagrant up

Your virtual machine will now be automatically downloaded, installed and
configured to run the knuvu web application. It is possible you may run into
the following error.
